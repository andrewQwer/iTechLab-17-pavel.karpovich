...
class ProfileIpContainer extends Component {
	...
	addClickHandler = () => {
		if (this.calculateDomainRemainingCount() !== 0) {
			...
			this.props.UIActionCreators.showError(ErrorCodes.EXCEEDED_DOMAIN_COUNT_LIMIT);
		}
	};
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileIpContainer);
